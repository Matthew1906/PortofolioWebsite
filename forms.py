...
from wtforms import FileField, PasswordField, StringField, SelectMultipleField, SubmitField, TextAreaField
from wtforms.validators import DataRequired, regexp, URL

class ProjectForm(FlaskForm):
    name = StringField("Project name", validators=[DataRequired()])
    type = SelectMultipleField("Type",choices=[('Scripting', 'Scripting'), ('GUI (Tkinter or Turtle)', 'GUI'), ('Game', 'Game'), ('HTTP Requests & APIs', 'HTTP Requests and APIs'), ('Automation', 'Automation'), ('Web Development', 'Web Development'), ('Data Science','Data Science')],validators=[DataRequired()])
